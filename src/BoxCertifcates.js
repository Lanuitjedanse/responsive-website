  ...
  return (
    <>
      <div className="h-full bg-geers-blue flex items-center xs:bg-white sm:bg-white md:bg-white">
        <div className="flex flex-col items-center justify-around h-96 w-96 bg-white border-1 mr-10 border-gray-50 xs:mr-0 xs:w-100 xs:h-100 sm:w-100 sm:-h100 md:w-100 md:h-100">
